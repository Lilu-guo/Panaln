...
void ABS_FM::mycodetable(){ 
	...
	memset(C, 0, 16 * 4);
	C[0]=0;          C[1]=3077224;    C[2]=2048660992;  C[3]=2051143963;  C[4]=3474995541;  C[5]=3477492929;  C[6]=3477621710;  C[7]=3487542169; 
...
{	
	...
	SA[0] = n;
	cout<<"build tree n:"<<n<<"  D:"<<this->D<<endl;       
...
int ABS_FM::loadIdx()
{
	...
	cout<<"load newD ..."<<endl;
	this->newD = new Dmap(); 
	string fnewD2 = "/home/lab/gll/panaln/mg-aligner/FM/newD.idx3";
	loadkit s2(fnewD2.c_str());
	newD->load(s2); 
	s2.close();
	cout<<"load Ltree ..."<<endl;
	string flroot2 = "/home/lab/gll/panaln/mg-aligner/FM/lroot.idx3";
	loadkit s3(flroot2.c_str());
	LoadWTTree(s3, lroot); 
	s3.close();
	cout<<"load Rtree ..."<<endl;
	string frroot2 = "/home/lab/gll/panaln/mg-aligner/FM/rroot.idx3";
	loadkit s4(frroot2.c_str());
	LoadWTTree(s4, rroot); 
	s4.close();
	cout<<"load SAL ..."<<endl;
	string fsal2 = "/home/lab/gll/panaln/mg-aligner/FM/sal.idx3";
	loadkit s5(fsal2.c_str());
	this->SAL = new InArray();
	SAL->load(s5); 
	s5.close();
	cout<<"load RANKL ..."<<endl;
	string rankl2 = "/home/lab/gll/panaln/mg-aligner/FM/rankl.idx3";
	loadkit s6(rankl2.c_str());
	this->RankL =new InArray();
	RankL->load(s6);
	s6.close();
	cout<<"load newd ..."<<endl;
	string fnewd2 = "/home/lab/gll/panaln/mg-aligner/FM/newd.idx3";
	loadkit s7(fnewd2.c_str());
	this->newd = new Dmap();
	newd->load(s7);
	this->sa0_index =2932456607;
	this->D =32; 
	this->n =6971866258; 
	this->alphabetsize =15; 
	this->C =new fm_int[alphabetsize+1]; 
	mycodetable(); 
}
